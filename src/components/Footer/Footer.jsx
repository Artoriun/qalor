        ...
        <div style={{ 
          ...
          <div>
            ...
            <div style={{ lineHeight: '2', color: 'white', fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", sans-serif' }}>
              ...
              <p><a href="https://maps.app.goo.gl/svtgb5ivAYVd9MXAA" style={{ color: 'white', textDecoration: 'none', outline: 'none' }} onFocus={(e) => e.target.style.outline = 'none'} onBlur={(e) => e.target.style.outline = 'none'}>Lange Marktstraat 1, 8911 AD, Leeuwarden</a></p>

import{r as s,j as n}from"./index-DN9d9r5_.js";import{P as w}from"./Particles-DGSuSDqB.js";const y="/assets/hero-optimized-BCsx33Bv.webp",S=({darkMode:b})=>{const[t,m]=s.useState(!1),[v,g]=s.useState(!1);s.useEffect(()=>{const e=()=>{m(window.innerWidth<=768),g(window.innerHeight<window.innerWidth&&window.innerWidth<=768)};return e(),window.addEventListener("resize",e),window.addEventListener("orientationchange",e),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),s.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
      .wat-wij-doen-btn {
        position: relative;

import{r as a,j as n}from"./index-CRRc9-T1.js";import{P as y}from"./Particles-CgOqXCTp.js";const b="/qalor/assets/hero-Boyit2u3.webp",S=({darkMode:m})=>{const[t,g]=a.useState(!1),[v,h]=a.useState(!1);a.useEffect(()=>{const e=()=>{g(window.innerWidth<=768),h(window.innerHeight<window.innerWidth&&window.innerWidth<=768)};return e(),window.addEventListener("resize",e),window.addEventListener("orientationchange",e),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),a.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
      .wat-wij-doen-btn {
        position: relative;

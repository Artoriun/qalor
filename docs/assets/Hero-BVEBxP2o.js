import{r as s,j as n}from"./index-CxSjgETB.js";import{P as w}from"./Particles-CMNeM8Wm.js";const I=({darkMode:y})=>{const[t,m]=s.useState(!1),[b,g]=s.useState(!1);s.useEffect(()=>{const e=()=>{m(window.innerWidth<=768),g(window.innerHeight<window.innerWidth&&window.innerWidth<=768)};return e(),window.addEventListener("resize",e),window.addEventListener("orientationchange",e),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),s.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
      .wat-wij-doen-btn {
        position: relative;
